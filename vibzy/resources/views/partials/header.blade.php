...
<div class="top-banner" role="region" aria-label="Top announcement">
  <div class="container d-flex flex-column flex-md-row justify-content-between align-items-center text-white py-2">
    <div class="banner-text text-center text-md-start">
      <strong>BIG NEWS</strong> — Sponsorships are now available. No platform fees.
    </div>
...
<!-- Header / navigation -->
<header class="site-header bg-transparent py-3" role="banner">
  <nav class="navbar navbar-expand-lg navbar-light">
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarMain">
        <!-- Navigation Links -->
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 site-nav">
          <li class="nav-item"><a class="nav-link" href="{{ route('home') }}">Home</a></li>
          <li class="nav-item"><a class="nav-link" href="{{ route('products') }}">Creator-Hub</a></li>
